        ...
        <div class="row justify-content-center">
            <div class="col-md-8">
                <div class="card">
                    ...
                    <div class="card-body">
                        <form method="POST" action="{{ route('nests.update', $nest->name) }}" enctype="multipart/form-data">
                            @csrf
                            @method('PUT')
                            ...
                            <div class="form-group mb-3">
                                ...
                                <textarea class="form-control" id="description" name="description" rows="3" required>{{ $nest->description }}</textarea>
                            </div>
                            <div class="form-group mb-3">
